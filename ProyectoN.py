...
def calcular_puntaje_seguridad(contrasena):
    ...
    patrones_obvios = leer_archivo('/Users/enr.g/Documents/proyecto/patrones_obvios.txt')
...
# Función principal
def main():
    contrasenas = leer_archivo('/Users/enr.g/Documents/proyecto/Contrasenas.txt')
    resultados = []
